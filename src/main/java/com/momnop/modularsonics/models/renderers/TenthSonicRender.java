...
public class TenthSonicRender
  extends TileEntitySpecialRenderer
{
  private final ModelTenthSonic model;
  
  public TenthSonicRender()
  {
  ...
  public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale)
  {
    ...
    Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("sonicscrewdriver:textures/models/tenthSonic.png"));
